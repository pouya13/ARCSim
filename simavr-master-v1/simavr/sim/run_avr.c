		...
		char *argv[])
{
	...
	printf("The executed instructions were saved to my_labels.txt\n");
	
	// for (int pouya = 0; pouya < avr -> pc; pouya = pouya + 2){
	// 	printf("%x: %x\n", pouya, (avr->flash[pouya] | (avr->flash[pouya + 1] << 8)));
	// }
	avr_terminate(avr);
}
